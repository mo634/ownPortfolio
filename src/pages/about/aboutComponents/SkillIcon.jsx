...
const SkillIcon = ({icon,insteadLogo,text}) => {
return (
    <>
        <motion.div
            ...
            {
                icon !== "" ?<FontAwesomeIcon icon={icon} className=" dark:text-[#0079ff]  w-[200px] h-[200px] " />
                    
                    : <p
                    className=' dark:text-[#0079ff] text-center
                    text-[120px]   w-[200px] h-[200px] font-bold
                    '
                    >{insteadLogo}</p>
            }
